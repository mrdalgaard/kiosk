...
(1, 'Alle åg-ender på PTO-akslen', 25, CURRENT_TIMESTAMP, NULL),
(2, 'PTO-slanger', 80, CURRENT_TIMESTAMP, NULL),
(3, 'Hydraulikstempel', 40, CURRENT_TIMESTAMP, NULL),
(4, 'Hjulets drejepunkt', 80, CURRENT_TIMESTAMP, NULL),
(5, 'Hjulets aksel', 80, CURRENT_TIMESTAMP, NULL),
(6, 'Kontrollér oliestanden i gearkasserne', 80, CURRENT_TIMESTAMP, NULL),
(7, 'Udskift olien i gearkasserne', 400, CURRENT_TIMESTAMP, NULL)
